(function ( $, x5engine ) {
	...
	s.siteId = '8090C297C312BAC0F42E6C7A342C595E';
	...
	b.push(function () {
		x5engine.captcha.instance = new x5engine.captcha.x5captcha({
			"offlineCodes": {
				"0": { letter: 'A', path: 'captcha/imcpa_clh.gif'},
				"1": { letter: '6', path: 'captcha/imcpa_ycr.gif'},
				"2": { letter: 'G', path: 'captcha/imcpa_47f.gif'},
				"3": { letter: 'L', path: 'captcha/imcpa_rle.gif'},
				"4": { letter: 'S', path: 'captcha/imcpa_hac.gif'},
				"5": { letter: 'N', path: 'captcha/imcpa_eec.gif'},
				"6": { letter: 'V', path: 'captcha/imcpa_kgc.gif'},
				"7": { letter: '5', path: 'captcha/imcpa_mev.gif'},
				"8": { letter: 'L', path: 'captcha/imcpa_kmm.gif'},
				"9": { letter: 'M', path: 'captcha/imcpa_xfa.gif'}
			}
		});
	}, false, 'first');
